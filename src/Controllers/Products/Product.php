...
class Product extends PublicController
{
    ...
    public function run(): void
    {
        try {
            ...
            Site::redirectToWithMsg("index.php?page=Products_Products", $ex->getMessage());
        }
    }
    ...
    private function handleInsert()
    {
        ...
        if ($result > 0) {
            Site::redirectToWithMsg("index.php?page=Products_Products", "Producto creado exitosamente");
        }
    }
    ...
    private function handleUpdate()
    {
        ...
        if ($result > 0) {
            Site::redirectToWithMsg("index.php?page=Products_Products", "Producto actualizado exitosamente");
        }
    }
    ...
    private function handleDelete()
    {
        ...
        if ($result > 0) {
            Site::redirectToWithMsg("index.php?page=Products_Products", "Producto eliminado exitosamente");
        }
    }
